...
<header id="header" class="vh-100" style="padding-top:400px; 
   ...
   <div class="container">
      <div class="">
         <h1 class="text-capitalize text-white text-center"><h1 class="text-capitalize text-white text-center">Dwójka wspaniałych uczniów w trzeciej TP<br> Projekt na lekcje<br>Maksymilian Laska<br>Karol Poplewski</h1></h1>
      </div>
   </div>
</header>
